...
Zk-Torch supports reading of the ptau files generated by the `snarkjs` tool. See the snarkjs documentation for more details:
https://github.com/iden3/snarkjs?tab=readme-ov-file#1-start-a-new-powers-of-tau-ceremony
(Note: the ptau file used in the instruction above is `challenge_0003` and the `pow_len_log` is 14)
