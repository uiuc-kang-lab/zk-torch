...
impl BasicBlock for OrderedBasicBlock {
  ...
  fn prove(
    ...
    #[cfg(feature = "gpu")]
    let g_diff_x = util::gpu_msm_g1(&srs.IX1A as &Vec<IG1A>, &g_diff_poly.coeffs as &Vec<Fr>);
    ...
    #[cfg(feature = "gpu")]
    let q_diff_x = util::gpu_msm_g1(&srs.IX1A as &Vec<IG1A>, &q_diff_poly.coeffs as &Vec<Fr>) + srs.Y1P * r_Q_diff;
    ...
    #[cfg(feature = "gpu")]
    let r_diff_plus_r_Q_diff_x = util::gpu_msm_g1(&srs.IX1A as &Vec<IG1A>, &r_diff_plus_r_Q_diff.coeffs as &Vec<Fr>);
